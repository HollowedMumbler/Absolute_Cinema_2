  ...
  return (
    <div className="bg-background flex min-h-screen items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader>
          <CardTitle className="mb-2 text-center text-3xl font-bold text-white">
            Welcome to EcoRacer
          </CardTitle>
        ...
        <CardFooter>
          <Button
            className="w-full bg-linear-to-r from-green-500 to-emerald-600 px-8 py-6 text-lg text-white hover:from-green-600 hover:to-emerald-700"
